(function (window) {
    ...
    var isInViewport = function (el) {
      ...
      // Vertical
      var isInViewVertically =
        dimensions.bottom - dimensions.height * verticalOffset > 0 &&
        dimensions.top + dimensions.height * verticalOffset < viewport.height;
  
      // Horizontal
      var isInViewHorizontally =
        dimensions.right - dimensions.width * horizontalOffset > 0 &&
        dimensions.left + dimensions.width * horizontalOffset < viewport.width;
